...
def mcpl_white_black(pgn):
    ...
    return (int(statistics.median(losses_white)), int(statistics.median(losses_black)))
...
def read_pgn_and_update_db(path):
    ...
    db = client.get_database("mcplstats")
